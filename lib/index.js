...
var TrustlyConstructor = function(config) {
    ...
    */
    ...
    self._loadKeys = function() {
        ...
        fs.readFile(self.config.publicKeyPath, 'utf8', function(
            err,
            publicKey
        ) {
        ...
        if (Object.prototype.toString.call(data) === '[object Object]') {
            ...
            for (var i = 0; i < keys.length; i++) {
                ...
                if (data[k] === null) {
                    ...
                    serializedData =
                        serializedData + k + self._serializeData(data[k])
                }
            }
            ...
            parseErr = function(err) {
                ...
                if (err && err.error) {
                    ...
                    tError.method = err.error.error.method
                        ...
                        : null
                    tError.uuid = err.error.error.uuid
                        ? err.error.error.uuid
                        : null
                    tError.message = err.error.message
                        ? err.error.message
                        : null
            ...
            Q.fcall(function() {
                ...
                .then(function(trustlyResponse) {
                    ...
                    if (trustlyResponse.result) {
                        deferred.resolve(
                            self._verifyResponse(trustlyResponse.result)
                        )
